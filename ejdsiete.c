...
int main(void){
    ...
    if (prom2 > prom5)
        printf("El promedio de los primeros %d multiplos de 2 es mayor que los primeros %d multiplos de 5.\n", x, y);
         else if (prom2 < prom5)
        printf("El promedio de los primeros %d multiplos de 2 es menor que los primeros %d multiplos de 5.\n", x, y);
    else
        printf("El promedio de los primeros %d multiplos de 2 es igual al promedio de los primeros %d multiplos de 5.\n", x, y);
