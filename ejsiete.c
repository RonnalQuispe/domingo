...
int main(void){ //  Comienza la función principal.
    ...
    if (l % 2 == 0){//  Comprueba si 'l' es par utilizando el operador módulo.
            printf("%d, ", l);} //  Si 'l' es par, imprímelo seguido de una coma y un espacio.
    }
